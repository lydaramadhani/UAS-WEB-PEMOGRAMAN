...
urlpatterns = [
    ...
    # Stakeholder 2: Event Organizer (EO)
    ...
    # Stakeholder 3: Master Admin
    path('master-admin/users/', views.admin_user_manage_view, name='admin_user_manage'),
    path('master-admin/users/<int:user_id>/toggle-role/', views.admin_user_toggle_role_view, name='admin_user_toggle_role'),
]
